...
def prepare_data_for_modeling(df):
    ...
    ("Male", male_condition),
    ("Female", female_condition),
    ("Age_30s-40s", df['Age Group'] == '30s-40s'),  # Updated
    ("Age_50s", df['Age Group'] == '50s'),
    ("Age_60+", df['Age Group'] == '60+'),
    ("Male_50s", (male_condition) & (df['Age Group'] == '50s')),
    ("Female_50s", (female_condition) & (df['Age Group'] == '50s')),
    # You might want to add these intersectional groups as well
...
# Add this helper function just before the calibrate_thresholds function
...
def apply_calibrated_predictions(X_test, y_test, demographic_models, test_demographics, intersectional_groups, thresholds):
    ...
    # 'Male': 1.5,
    # 'Female': 1.5,
    # 'Age_30s-40s': 1.7,  # Updated name
    # 'Age_50s': 1.0,
    # 'Age_60+': 2.0,  # Updated name
    # 'Male_30s-40s': 1.5,  # New group
    # 'Male_50s': 1.5,
    # 'Male_60+': 1.5,  # New group
    # 'Female_30s-40s': 1.5,  # New group
    # 'Female_50s': 1.0,
    # 'Female_60+': 1.5  # New group
# }
    model_weights = {
    'All': 1.0,
    'Male': 1.5,
